  ...
  async (dispatch) => {
    ...
    try {
      const res = await axios.get(
        `${process.env.REACT_APP_API_BASE_URL}/api/ad?option=notexpired`,
        config
      );
...
export const loadAdDetails = (adId) => async (dispatch) => {
  try {
    ...
    const res = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/api/ad/${adId}`);
...
export const loadHighestBid = (adId) => async (dispatch) => {
  const url = `${process.env.REACT_APP_API_BASE_URL}/api/bid/${adId}`;
  try {
...
export const postAd = (data) => async (dispatch) => {
  const url = `${process.env.REACT_APP_API_BASE_URL}/api/ad`;
  try {
...
export const startAuction = (adId) => async (dispatch) => {
  const url = `${process.env.REACT_APP_API_BASE_URL}/api/auction/start/${adId}`;
  try {
...
export const getUserPurchasedAds = () => async (dispatch) => {
  const url = `${process.env.REACT_APP_API_BASE_URL}/api/user/product/purchased`;
  try {
    const res = await axios.get(url);
